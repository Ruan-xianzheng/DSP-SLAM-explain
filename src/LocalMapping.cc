...
{
    py::module optim  = py::module::import("reconstruct.optimizer"); //导入python模块
    ...
    mpLastKeyFrame = static_cast<KeyFrame*>(NULL);//表示当前没有最后一个关键帧
    nLastReconKFID = 0;//表示当前没有最后一个重建的关键帧的ID
}
